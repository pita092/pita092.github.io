// "use client"
//
// import { Home, User, Briefcase, FileText, ChevronRight, ChevronDown } from "lucide-react"
...
//                   <SidebarMenuButton onClick={() => scrollToSection(item.id)} className="cursor-pointer">
...
//                       <SidebarMenuButton onClick={() => toggleCategory(category)} className="cursor-pointer w-full">
...
//                             <SidebarMenuSubButton onClick={() => handleBlogClick(post.slug)} className="cursor-pointer">
//                               {post.title}
//                             </SidebarMenuSubButton>
//                           </SidebarMenuSubItem>
//                         ))}
